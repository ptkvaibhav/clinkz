...
<!-- NEGATIVE CONTROL — DELETE. Deliberately oversized to prove the
     `Context budget` required check blocks a merge. This branch is a
     throwaway and must never be merged. -->

Padding line proving the guard measures what is committed, not what is claimed.
Padding line proving the guard measures what is committed, not what is claimed.
Padding line proving the guard measures what is committed, not what is claimed.
Padding line proving the guard measures what is committed, not what is claimed.
Padding line proving the guard measures what is committed, not what is claimed.
